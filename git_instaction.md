...
Уточню, что все данные необходимо загружать из корневой папки. В ином случае может быть ошибка или файл не уйдет по назначению.

### Работа с чужим репозиторием на github.com/
Работа с любым частным репозиторием начинается со входа на github.com, затем поиском в нем находим нужный или интересный нам проект и командой/кнопкой **Fork** на сайте создаем копию на свой аккаунт, командой **git clone** отправляем в новую папку  на свой компьютер.
Отработав нужные изменения на своем рабочем месте, командой **git push** отправляем измененный файл на свой аккаунт в ***github.com*** проверяем все загруженные данные и затем кнопкой/командой **pull request** направляем изменения владельцу репозитория в котором мы внесли изменения. Одновременно владелец получает сообщение о внесенных дополнениях.
...
* mv [dir1]/*.* [dir2] - перемещение файла из одной в другую директорию.
* ls - список файлов.